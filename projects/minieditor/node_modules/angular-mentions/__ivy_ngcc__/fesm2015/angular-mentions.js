...
function MentionListComponent_li_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mousedown", function MentionListComponent_li_4_Template_a_mousedown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r9); const i_r6 = ctx.index; const ctx_r8 = ɵngcc0.ɵɵnextContext(); ctx_r8.activeIndex = i_r6; ctx_r8.itemClick.emit(); return $event.preventDefault(); });
...
MentionListComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MentionListComponent, selectors: [["mention-list"]], viewQuery: function MentionListComponent_Query(rf, ctx) { if (rf & 1) {
...
MentionListComponent = __decorate([ __metadata("design:paramtypes", [ElementRef])
...
MentionDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MentionDirective, selectors: [["", "mention", ""], ["", "mentionConfig", ""]], hostAttrs: ["autocomplete", "off"], hostBindings: function MentionDirective_HostBindings(rf, ctx) { if (rf & 1) {
...
MentionDirective = __decorate([ __metadata("design:paramtypes", [ElementRef,
...
MentionModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: MentionModule });
MentionModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function MentionModule_Factory(t) { return new (t || MentionModule)(); }, imports: [[
            CommonModule
        ]] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MentionListComponent, [{
        type: Component,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MentionDirective, [{
        type: Directive,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MentionModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    MentionDirective,
