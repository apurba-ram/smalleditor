...
@Component({
  ...
  <div class="editorContainer active">
    ...
    <div (click)="falseEmoji()" (paste)="onPaste($event)" class="editor active" [mentionConfig]="mentionConfig"
        (closed)="mentionClosed()" contenteditable (input)="setValue($event.target.innerText, $event.target.innerHTML)"
        ...
        <div class="controls-left">
            <span class="left" *ngIf="activeEditorOption">
                <button class="button" [class.active]="bold" (click)="insertBold()">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                        id="Capa_1" x="0px" y="0px" viewBox="0 0 202 202" style="enable-background:new 0 0 202 202;"
                        xml:space="preserve">
                        <path
                ...
                <button class="button" [class.active]="italic" (click)="insertItalic()">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 330.003 330.003"
                        style="enable-background:new 0 0 330.003 330.003;" xml:space="preserve">
                        <path id="XMLID_16_"
                ...
                <button *ngIf="link" class="button"><i class="vc-icons font14"
                        (click)="openDialog()">&#xea09;</i></button>
                ...
                <button class="button" (click)="insertBlockQuote()" [class.active]="blockquote">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="123.961px" height="123.961px"
                        viewBox="0 0 123.961 123.961" style="enable-background:new 0 0 123.961 123.961;"
                        xml:space="preserve">
                        <g>
                ...
                <span *ngIf="list">
                    ...
                    <button class="button" [class.active]="unorderedList" (click)="insertUnorderedList()"
                        ...
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 394.667 394.667"
                            style="enable-background:new 0 0 394.667 394.667;" xml:space="preserve">
                            <g>
                                <g>
                                    <g>
                                        <path
                                            d="M32,37.333c-17.707,0-32,14.293-32,32s14.293,32,32,32s32-14.293,32-32S49.707,37.333,32,37.333z" />
                                        <path
                                            d="M32,165.333c-17.707,0-32,14.293-32,32s14.293,32,32,32s32-14.293,32-32S49.707,165.333,32,165.333z" />
                                        <path
                                            d="M32,293.333c-17.813,0-32,14.4-32,32c0,17.6,14.4,32,32,32c17.6,0,32-14.4,32-32C64,307.733,49.813,293.333,32,293.333z" />
                            ...
                            <g>
                                <g>
                                    <g>
                                        ...
                                        <path
                                            d="M182.144,89.824H491.54c11.024,0,19.961-8.937,19.961-19.961c0-11.024-8.937-19.961-19.961-19.961H182.144
                                        c-11.024,0-19.961,8.937-19.961,19.961C162.183,80.888,171.12,89.824,182.144,89.824z" />
                                        <path
                                            d="M51.111,361.294c-0.12,0-0.236,0.016-0.354,0.018c-0.12-0.002-0.235-0.018-0.354-0.018
                                        ...
                                        <path
                                            d="M491.54,235.54H182.144c-11.024,0-19.961,8.937-19.961,19.961c0,11.024,8.937,19.961,19.961,19.961H491.54
                                        c11.024,0,19.961-8.937,19.961-19.961C511.501,244.476,502.564,235.54,491.54,235.54z" />
                                        <path
                                            d="M491.54,416.187H182.144c-11.024,0-19.961,8.937-19.961,19.961c0,11.024,8.937,19.961,19.961,19.961H491.54
                ...
                <span *ngIf="indent">
                    ...
                    <button class="button" [class.active]="increaseIndent" (click)="increaseIndentation()">
                        <svg class="ck ck-icon ck-button__icon" viewBox="0 0 14 20">
                            <path
                                d="M2 3.75c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm5 6c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zM2.75 16.5h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 1 0 0 1.5zM1.632 6.95L5.02 9.358a.4.4 0 0 1-.013.661l-3.39 2.207A.4.4 0 0 1 1 11.892V7.275a.4.4 0 0 1 .632-.326z">
                            </path>
                        </svg>
                    </button>
            ...
            <div class="right">
                ...
                <div *ngIf="mentionConfig.length > 0">
                    <div class="borderRgt"></div>
                    <button class="button bluetxt" (click)="insChar(elem.symbol)" [style.display]="'inline'"
                        *ngFor="let elem of mentionConfig">
                        {{elem.symbol}}
                    </button>
                </div>
                <div *ngIf="file">
